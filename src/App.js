			...
			<div className="colorlib-footer">
				<p>
					<small> This website is made by 
					  <br></br>
					 <a href="https://imaditya.ml/" target="_blank"> Aditya Shankar Mishra</a>
                   </small>
				</p>
				<ul>
					...
					<li><a href="https://www.linkedin.com/in/aditya-shankar-mishra/"><i className="icon-linkedin2"></i></a></li>
				</ul>
			</div>
